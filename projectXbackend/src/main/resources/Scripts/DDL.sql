-- DROP SCHEMA xchangeit;

CREATE SCHEMA xchangeit AUTHORIZATION postgres;
...
CREATE TABLE xchangeit.item_category_lookup (
	...
	CONSTRAINT item_category_lookup_pk PRIMARY KEY (id)
);


-- xchangeit.item_color definition

-- Drop table

-- DROP TABLE xchangeit.item_color;

CREATE TABLE xchangeit.item_color (
	id varchar NOT NULL,
	code varchar NOT NULL,
	"name" varchar NULL,
	CONSTRAINT item_color_pk PRIMARY KEY (id)
);
...
-- xchangeit.item_location definition

-- Drop table

-- DROP TABLE xchangeit.item_location;

CREATE TABLE xchangeit.item_location (
	id int4 NOT NULL,
	area int4 NOT NULL,
...
CREATE TABLE xchangeit."user" (
	...
	CONSTRAINT user_un_phone_num UNIQUE (phone_number),
...
-- xchangeit.user_ratings definition

-- Drop table

-- DROP TABLE xchangeit.user_ratings;

CREATE TABLE xchangeit.user_ratings (
	id int4 NOT NULL,
	rating varchar NULL,
	...
	CONSTRAINT user_ratings_fk FOREIGN KEY (user_id) REFERENCES xchangeit."user"(id),
	CONSTRAINT user_ratings_fk_1 FOREIGN KEY (rating_by) REFERENCES xchangeit."user"(id)
);
...
CREATE TABLE xchangeit.item (
	...
	CONSTRAINT item_fk1 FOREIGN KEY (location_id) REFERENCES xchangeit.item_location(id),
	CONSTRAINT item_fk2 FOREIGN KEY (owner_id) REFERENCES xchangeit."user"(id)
);
