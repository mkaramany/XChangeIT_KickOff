  ...
  render() {
    ...
    if (authUser) {
      if (authUser.profilePictureUrl) {
        profilePictureSrc = authUser.profilePictureUrl;
      } else if (authUser.profilePicture) {
        profilePictureSrc = "data:image/jpeg;base64," + authUser.profilePicture;
      }
    }
    console.log("header src", profilePictureSrc);
    return (
      <AppBar
      ...
      >
        <Toolbar className="app-toolbar" disableGutters={false}>
          ...
          <ul className="header-notifications list-inline ml-auto">
            ...
            {navigationStyle === HORIZONTAL_NAVIGATION && this.props.authUser && (
...
export default withRouter(
  connect(mapStateToProps, { toggleCollapsedNav, switchLanguage , userSignOut, setDefaultLanguage})(Header)
);
